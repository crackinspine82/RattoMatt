...
export default function GenerateQuestionBank() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      await enqueueJob('generate_question_bank', { chapter_id: chapterId });
  ...
  return (
    <div>
      <h1 style={{ margin: '0 0 24px', fontSize: 24 }}>Generate Question Bank</h1>
      <p style={{ color: 'var(--text-muted)', marginBottom: 24 }}>
        Requires structure to be published for the chapter. Runs question-bank-generate (--from-db) → merge node IDs → import questions.
      </p>
