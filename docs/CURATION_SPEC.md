...
## 5. Structure + Study Notes Editor (Single Pane)
...
## 6. Publish Script Behaviour

### 6.1 Structure and Notes (unchanged)
...
### 6.2 Questions: incremental add/update only
...
## 7. Extraction: Single Script (Structure + Notes)
